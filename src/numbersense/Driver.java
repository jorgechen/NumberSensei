...
public class Driver {
	...
	public static void main(String[] args) {
		if (args.length != 0) {
			...
			Exam[] exams = {new Exam(40, new Level32(), Category.MULTIPLICATION_BY_5),
						   new Exam(40, new Level32(), Category.MULTIPLICATION_BY_25),
						   new Exam(40, new Level32(), Category.MULTIPLICATION_BY_125)};
